 ...
 * lcd.h
 *
 * Modified on: March 27, 2016
 *      Author: Roscoe Giles
 */

/*
 * The LCD panel is connected to the low 6 pins of 1 port (Port 2 below)
 ...
 *
 * These both send a 9-bit value to the LCD. (RSbit + 8 bits to send)
